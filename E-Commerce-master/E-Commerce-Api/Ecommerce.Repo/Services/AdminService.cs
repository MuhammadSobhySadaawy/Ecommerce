...
namespace Ecommerce.Api.Services
{
    public class AdminService : IAdminService
    {
        ...
        public AdminService(IMapper mapper, IBaseRepository<Order> OrderRepository, IBaseRepository<SubCategory> subcategoryRepository, IBaseRepository<Category> categoryRepository, UserManager<ApplicationUser> userManager, IBaseRepository<ApplicationUser> genericRepository, ContextDB db,
